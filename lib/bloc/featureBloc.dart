...
class FeaturedLocationBloc {
  ...
  Stream<LocationModel> get featuredLocationWeather => _featuredLocationFetcher.stream;

  fetchFeaturedWeather(String city) async {
    LocationModel weatherResponse = await _repository.fetchFeaturedWeather(city);
